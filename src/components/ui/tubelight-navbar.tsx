...
export function NavBar({ items, className }: NavBarProps) {
  ...
  return (
    <div className={cn("bottom-0 sm:top-0 left-1/2 z-50 mb-6 sm:pt-6", className)}>
      <div className="bg-gradient-to-r from-gray-500 to-blue-500 text-transparent flex items-center gap-3 bg-background/5 border border-border backdrop-blur-lg py-1 px-1 rounded-full shadow-lg">
        {items.map((item) => {
